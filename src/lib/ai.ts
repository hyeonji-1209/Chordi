...
6. 콘티 제목(title)은 "날짜 + 예배명"으로 짓는다. 예: "7월 19일 주일 1부", "7월 16일 수요예배", "7월 18일 청년부".
   예배 종류(주일 1부/2부, 청년부, 수요예배, 목요예배, 금요철야 등)는 사용자의 말에서 파악하고,
   없으면 오늘 날짜 기준 다가오는 주일 예배로 짓는다. 같은 예배의 콘티는 하나뿐이므로 제목이 그 기준이 된다.
